 ...
 * @LastEditTime: 2019-11-25 10:22:23
...
export default {
  route: {
    ...
    service: '客服中心',
    communication: '客服沟通',
    publicAddressManagement: '公众号管理',
    miniProgramManagement: '小程序管理',
    commentCenter: '评论中心',
    ...
    voteTaskCreate: '创建任务',
    voteTaskModify: '编辑任务',
    integralMarketing: '积分抽奖',
    marketingActivity: '活动列表',
