<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="姓名：">{{mainFrm.name}}</el-form-item>
      <el-form-item label="作品名称：">{{mainFrm.title}}</el-form-item>
      <el-form-item label="手机号码：">{{mainFrm.phone}}</el-form-item>
      <el-form-item label="邮箱：">{{mainFrm.email}}</el-form-item>
      ...
      <el-form-item label="设计理念：">
        {{mainFrm.design}}
        <span class="no_data" v-if="!mainFrm.design">用户未填写</span>
      </el-form-item>
      <el-form-item label="Logo：">
        <a v-if="mainFrm.logo" target="_blank" :href="mainFrm.logo">
          <img :src="mainFrm.logo" alt />
        </a>
