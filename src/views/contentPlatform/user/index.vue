  ...
  <div class="app-container">
    <div class="control-group">
      <el-form :inline="true" :model="userListQueryFrm">
        ...
        <el-form-item label="微信/微博昵称">
          <el-input placeholder="微信/微博昵称" v-model="userListQueryFrm.nickname"></el-input>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      actionHandler(type, info) {
        if (type === 'detail') { // 查看详情
          this.$router.push({ name: 'contentUserDetail', params: { id: info.id }});
        }
      },
