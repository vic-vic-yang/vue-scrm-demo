<template>
  <div class="app-container integral-details">
    <div class="control-group">
      <el-form :inline="true" ref="orderQueryFrm" :model="orderQueryFrm">
        ...
        <!--</el-form-item>-->
        <el-form-item prop="status" label="积分状态">
          <el-select placeholder="全部积分数据" clearable v-model="orderQueryFrm.status">
            <el-option
      ...
      getData() {
        ...
        integral.details({
          ...
          this.tableData = (res.result || []).map(item => {
            return {
              ...item,
              integral: item.integral * 1 > 0 ? '+' + item.integral : item.integral,
